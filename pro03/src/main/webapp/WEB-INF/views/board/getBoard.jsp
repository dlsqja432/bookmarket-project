		...
		<div style="width:1400px; margin:0 auto;">
			...
			<div>
				...
				<div class="btn-group">
				  ...
				  <a href="${path0 }/board/editBoard.do?bno=${board.bno }" class="button btn-secondary">글 수정</a>
				  <a href="${path0 }/board/delBoard.do?bno=${board.bno }" class="button btn-danger">글 삭제</a>
				  </c:if>
