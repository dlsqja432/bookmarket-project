							...
							<tbody>
								<tr>
									...
									<td>
										<div class="item_fr">
											...
											<input type="hidden" id="name" value="${memb.name }" />
											<input type="hidden" id="pname" value="${product.pname }" />
											<input type="hidden" name="id" id="id" value="${memb.id }" />
											<input type="hidden" id="email" value="${memb.email }" />
											<input type="hidden" id="custel" value="${memb.tel }" />
											<input type="hidden" id="cusaddr" value="${memb.addr1 }" />
											<input type="hidden" id="cusaddr2" value="${memb.addr2 }" />
											<input type="hidden" id="cuspostcode" value="${memb.postcode }" />
								...
								<tr>
									...
									<td>
										<div class="item_fr">
											<strong>단가 </strong> : 
											<input type="number" id="price" value="${inventory.outprice }" class="input" style="display:inline-block; width:85%;" readonly /><br>
											<strong>수량 </strong> : 
