		                ...
		                <div class="table_form_wrap">
		                    <table class="table_form">
		                        ...
		                        <tr>
		                            ...
		                            <td><input type="text" name="id" id="id" size="100" class="input" value="${memb.id }" readonly required>
		                            </td>
		                        </tr>
		                        <tr>
		                        ...
		                        <tr>
		                            ...
		                            <td><input type="text" name="name" id="name" class="input"  value="${memb.name }" required></td>
		                        </tr>
		                        <tr>
		                            <th><label for="email">이메일</label></th>
		                            <td><input type="email" name="email" id="email" class="input" value="${memb.email }" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required></td>
		                        </tr>
		                        <tr>
		                            <th><label for="tel">전화번호</label></th>
		                            <td><input type="tel" name="tel" id="tel" class="input"  value="${memb.tel }" pattern="[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}" required></td>
		                        </tr>
		                        <tr>
		                            <th><label for="" onclick="findAddr()">주소</label></th>
		                            <td>
		                                <input type="text" name="addr1" id="addr1" class="input" value="${memb.addr1 }"><br>
		                                <input type="text" name="addr2" id="addr2" class="input" value="${memb.addr2 }"><br>
		                                <input type="text" name="postcode" id="postcode"  class="input" value="${memb.postcode }">
