    	...
    	<div id="breadcrumb" class="container breadcrumb-wrap clr-fix" style="height:60px; line-height:60px;">
	    	<nav class="breadcrumb" aria-label="breadcrumbs">
			  <ul>
			    ...
			    <li><a href="${path2 }/free/freeList.do">Free</a></li>
 	    ...
 	    <section class="page" id="page1">
    		...
    		<div class="page-wrap">
	    		<div class="clr-fix">
	    			<br>
					<form action="${path2 }/free/editFreePro.do" method="post">
						<table class="table">
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="vcnt" id="vcnt" class="input" value="${free.hits }" disabled>
									</td>
								</tr>
							</tbody>
						</table>
						...
						<div class="buttons">
						  ...
						  <a href="${path2 }/free/freeList.do" class="button is-primary">글 목록</a>
						  <a href="${path2 }/free/getFree.do?no=${free.no} " class="button is-success">글 상세보기</a>
						</div>
					</form>
					<script>
					$(function(){
